            ...
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent>
                ...
                <form onSubmit={createInvoice} className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    <Label>Libellé</Label>
                    <Input name="label" required placeholder="Scolarité - Trimestre 1" />
                  </div>
                ...
                invoices.map((inv: any) => (
                  <TableRow key={inv.id}>
                    ...
                    <TableCell className="text-success font-medium">
                      {Number(inv.amount_paid).toLocaleString("fr-FR")} F
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Dialog
                        open={openPay === inv.id}
                        onOpenChange={(o) => setOpenPay(o ? inv.id : null)}
                      >
                        <DialogTrigger asChild>
                          <Button size="sm" variant="ghost" disabled={inv.status === "paid"}>
                          ...
                          <form onSubmit={(e) => recordPayment(e, inv)} className="space-y-3">
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                step="0.01"
                                required
                                defaultValue={Number(inv.amount) - Number(inv.amount_paid)}
                              />
                            </div>
                            <div className="space-y-1.5">
                              <Label>Mode</Label>
