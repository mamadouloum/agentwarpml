  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Planifiez les cours par classe et créneau horaire."
      />
          ...
          <div className="flex gap-3 items-end flex-wrap">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              <DialogTrigger asChild>
                <Button className="ml-auto" disabled={!classId}>
                ...
                <div key={d} className="space-y-2">
                  ...
                  <div className="space-y-2 min-h-48 rounded-lg border border-dashed border-border p-2 bg-secondary/30">
                    {byDay[i].map((s: any) => (
                      <div
                        key={s.id}
                        className="rounded-md bg-card border border-border p-2 text-xs shadow-sm"
                      >
